    ...
    <section id="services" className="relative py-28 px-6 bg-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-[#3d1230] font-light">服务项目</h2>
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-8">
            <h3 className="font-serif text-2xl text-[#3d1230] font-light">基础服务</h3>
            ...
            {basicServices.map((service) => (
              ...
              >
                <div className="mb-5 flex-1">
                  <h4 className="font-serif text-xl text-[#3d1230] mb-1 leading-snug group-hover:text-[#e8789a] transition-colors duration-300">
                    {service.name}
                  </h4>
        ...
        <div>
          <div className="flex items-center gap-3 mb-8">
            <h3 className="font-serif text-2xl text-[#3d1230] font-light">增值服务</h3>
            ...
            {addonServices.map((service) => (
              ...
              >
                <div className="min-w-0 mr-4">
                  <p className="text-sm font-medium text-[#3d1230] group-hover:text-[#e8789a] truncate transition-colors">
                    {service.name}
                  </p>
                  {service.duration && (
